 ...
 * @brief class Main Game script for run this project.
...
bool Game::Initialize()
{
	...
	mCamera.SetPosition(0.0f, 8.0f, 0.0f);
...
void Game::LoadTextures()
{
	...
	CreateTexture("TexTitle", L"../../Textures/ahfh7-s0u1j.dds");
	CreateTexture("TexMenu", L"../../Textures/a9qun-xzrvo.dds");
	CreateTexture("TexOption", L"../../Textures/aw54n-bg72t.dds");
	CreateTexture("TexPause", L"../../Textures/asdqw123.dds");
}
...
void Game::BuildDescriptorHeaps()
{
	...
	auto StarWarsTexTitle = mTextures["TexTitle"]->Resource;
	auto StarWarsTexMenu = mTextures["TexMenu"]->Resource;
	auto StarWarsTexOption = mTextures["TexOption"]->Resource;
	auto StarWarsTexPause = mTextures["TexPause"]->Resource;
...
void Game::BuildMaterials()
{
	...
	CreateMaterials("Option", XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f), XMFLOAT3(0.05f, 0.05f, 0.05f), 0.2f);
